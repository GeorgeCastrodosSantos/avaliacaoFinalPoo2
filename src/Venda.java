...
public class class Produto {
    ArrayList<Integer,String>nomes=new ArrayList<Integer,String>();
    ArrayList<Integer,Double>precos=new ArrayList<Integer,Double>();    
    ArrayList<Integer,Integer>quantidadeEmEstoque=new ArrayList<Integer,Integer>();
    ArrayList<Integer,LocalDateTime>dataDaVenda = new ArrayList<Integer,LocalDateTime>(); 
...
private static boolean processaOpcaoMenu(Scanner scanner, int opcao, ArrayList<Integer, String> nomes,
        ArrayList<Integer, Double> precos, ArrayList<Integer, Integer> quantidadeEmEstoque, Arraylist<Integer, LocalDateTime>dataDaVenda ) throws IOException, InterruptedException {
        switch (opcao){
            case 1:
...
private static void removerProduto(Scanner scanner2, ArrayList<Integer, String> nomes,
        ArrayList<Integer, Double> precos) throws IOException, InterruptedException {
            limparTela();
...
private static void listarProdutos(ArrayList<Integer, String> nomes, ArrayList<Integer, Double> precos,
    ArrayList<Integer, Integer> quantidadeEmEstoque) throws IOException, InterruptedException {
    limparTela();
...
private static void exibirMedia(ArrayList<Integer, Double> precos) {
    double media = 0,mediafinal =0,maiorValor = 0, menorValor=999;
...
private static void mostrarMenu() {
    System.out.println("CADASTRO DE PRODUTOS - Supermercado Max");
    System.out.println("------------------------------------");
